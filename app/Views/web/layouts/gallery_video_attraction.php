<div class="d-grid gap-2">
    ...
    <button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#gallery" <?= (count($item['gallery']) == 0) ? 'disabled' : ''; ?>>
        <span class="material-icons" style="font-size: 1.5rem; vertical-align: bottom">image</span> Open Gallery
    </button>
    <button type="button" id="video-play" class="btn-play btn btn-outline-primary" data-bs-toggle="modal" data-src="<?= base_url('media/videos/tracking/'.esc($item['video_url']).''); ?>" data-bs-target="#videoModal" <?= ($item['video_url'] == '') ? 'disabled' : ''; ?>>
